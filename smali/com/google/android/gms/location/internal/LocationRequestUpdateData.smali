...
# static fields
.field public static final CREATOR:Lhmk;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/gms/location/internal/LocationRequestUpdateData;->CREATOR:Lhmk;
...
.method public constructor <init>(IILcom/google/android/gms/location/internal/LocationRequestInternal;Landroid/os/IBinder;Landroid/app/PendingIntent;Landroid/os/IBinder;Landroid/os/IBinder;)V
    ...
    :goto_0
    iput-object v0, p0, Lcom/google/android/gms/location/internal/LocationRequestUpdateData;->c:Lhmz;
    ...
    :goto_1
    iput-object v0, p0, Lcom/google/android/gms/location/internal/LocationRequestUpdateData;->e:Lhmw;

    if-nez p7, :cond_4

    :goto_2
    iput-object v1, p0, Lcom/google/android/gms/location/internal/LocationRequestUpdateData;->f:Lhlt;

    return-void

    :cond_0
    invoke-static {p4}, Lhna;->a(Landroid/os/IBinder;)Lhmz;
    ...
    invoke-direct {v0, p6}, Lhmy;-><init>(Landroid/os/IBinder;)V

    goto :goto_1

    .line 0
    :cond_4
    invoke-static {p7}, Lhlu;->a(Landroid/os/IBinder;)Lhlt;
...
.method b()Landroid/os/IBinder;
    ...
    iget-object v0, p0, Lcom/google/android/gms/location/internal/LocationRequestUpdateData;->c:Lhmz;
    ...
    invoke-interface {v0}, Lhmz;->asBinder()Landroid/os/IBinder;
...
.method c()Landroid/os/IBinder;
    ...
    iget-object v0, p0, Lcom/google/android/gms/location/internal/LocationRequestUpdateData;->e:Lhmw;
...
.method d()Landroid/os/IBinder;
    ...
    iget-object v0, p0, Lcom/google/android/gms/location/internal/LocationRequestUpdateData;->f:Lhlt;
    ...
    invoke-interface {v0}, Lhlt;->asBinder()Landroid/os/IBinder;
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    invoke-static {p1, v1, v2, p2, v3}, Lacs;->a(Landroid/os/Parcel;ILandroid/os/Parcelable;IZ)V
