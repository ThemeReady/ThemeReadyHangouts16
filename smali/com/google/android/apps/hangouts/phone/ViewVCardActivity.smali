...
.method public constructor <init>()V
    ...
    iget-object v1, p0, Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;->F:Lkgr;

    invoke-direct {v0, p0, v1}, Ljgl;-><init>(Landroid/app/Activity;Lkfm;)V

    iget-object v1, p0, Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;->E:Lkcf;
    ...
    iput-object v0, p0, Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;->n:Ljfq;
    ...
    invoke-direct {v0, p0}, Lert;-><init>(Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;)V
    ...
    invoke-direct {v0, p0}, Lerp;-><init>(Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;)V
...
.method private a(Landroid/net/Uri;ILaiw;ZLjava/util/List;)Z
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p2}, Lajb;-><init>(I)V

    .line 557
    invoke-virtual {v1, p3}, Laix;->a(Laiw;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Lajl; {:try_start_0 .. :try_end_0} :catch_4
    .catch Laji; {:try_start_0 .. :try_end_0} :catch_6

    .line 560
    :try_start_1
    invoke-virtual {v1, v3}, Laix;->a(Ljava/io/InputStream;)V
    :try_end_1
    .catch Lajm; {:try_start_1 .. :try_end_1} :catch_2
    ...
    .catch Lajl; {:try_start_2 .. :try_end_2} :catch_4
    .catch Laji; {:try_start_2 .. :try_end_2} :catch_6
    ...
    .catch Lajl; {:try_start_3 .. :try_end_3} :catch_4
    .catch Laji; {:try_start_3 .. :try_end_3} :catch_6
    ...
    invoke-virtual {v1, v3}, Laix;->a(Ljava/io/InputStream;)V
    :try_end_6
    .catch Lajm; {:try_start_6 .. :try_end_6} :catch_7
    ...
    .catch Lajl; {:try_start_7 .. :try_end_7} :catch_4
    .catch Laji; {:try_start_7 .. :try_end_7} :catch_6
    ...
    .catch Lajl; {:try_start_8 .. :try_end_8} :catch_4
    .catch Laji; {:try_start_8 .. :try_end_8} :catch_6
    ...
    invoke-static {v5, v6, v1}, Lgnj;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_9
    ...
    .catch Lajl; {:try_start_a .. :try_end_a} :catch_4
    .catch Laji; {:try_start_a .. :try_end_a} :catch_6
    ...
    .catch Lajl; {:try_start_b .. :try_end_b} :catch_4
    .catch Laji; {:try_start_b .. :try_end_b} :catch_6
    ...
    invoke-direct {v1, v4}, Laji;-><init>(Ljava/lang/String;)V
    ...
    .catch Lajl; {:try_start_d .. :try_end_d} :catch_4
    .catch Laji; {:try_start_d .. :try_end_d} :catch_6
...
.method public static synthetic a(Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;Landroid/net/Uri;ILaiw;ZLjava/util/List;)Z
    .locals 6
    ...
    invoke-direct/range {v0 .. v5}, Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;->a(Landroid/net/Uri;ILaiw;ZLjava/util/List;)Z
...
# virtual methods
.method public a(Laia;Ljava/util/List;Ljava/util/List;)V
    .locals 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v1, v3, v0}, Liz;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 3618
    iget-object v0, p1, Laia;->a:Ljava/util/List;
    ...
    invoke-virtual {v1, v5, v6}, Liz;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v1, v5, v0}, Liz;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 3622
    :cond_4
    iget-object v0, p1, Laia;->b:Ljava/util/List;
    ...
    invoke-virtual {v0}, Laie;->d()Ljava/lang/String;
    ...
    .line 3626
    :cond_8
    iget-object v0, p1, Laia;->c:Ljava/util/List;
    ...
    invoke-virtual {v0}, Laip;->h()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Laip;->j()Ljava/lang/String;
    ...
    .line 217
    invoke-virtual {v0}, Laip;->b()Ljava/lang/String;
    ...
    .line 221
    :cond_9
    invoke-virtual {v0}, Laip;->c()Ljava/lang/String;
    ...
    .line 225
    :cond_a
    invoke-virtual {v0}, Laip;->d()Ljava/lang/String;
    ...
    .line 229
    :cond_b
    invoke-virtual {v0}, Laip;->e()Ljava/lang/String;
    ...
    .line 233
    :cond_c
    invoke-virtual {v0}, Laip;->f()Ljava/lang/String;
    ...
    .line 237
    :cond_d
    invoke-virtual {v0}, Laip;->g()Ljava/lang/String;
    ...
    invoke-virtual {v1, v6, v5}, Liz;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 3634
    :cond_12
    iget-object v0, p1, Laia;->e:Ljava/util/List;
    ...
    invoke-virtual {v0}, Laii;->b()Ljava/lang/String;
    ...
    .line 4630
    :cond_14
    iget-object v0, p1, Laia;->d:Ljava/util/List;
    ...
    invoke-virtual {v0}, Laim;->c()Ljava/lang/String;
    ...
    .line 289
    invoke-virtual {v0}, Laim;->d()Ljava/lang/String;
    ...
    .line 290
    invoke-virtual {v5, v6, v1}, Liz;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v5, v1, v0}, Liz;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 4642
    :cond_17
    iget-object v0, p1, Laia;->f:Ljava/util/List;
    ...
    invoke-virtual {v0}, Lais;->b()Ljava/lang/String;
    ...
    invoke-virtual {v2, v4, v0}, Liz;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 6614
    :cond_1a
    iget-object v0, p1, Laia;->g:Ljava/util/List;
    ...
    .line 336
    invoke-virtual {v0}, Lail;->b()Ljava/lang/String;
    ...
    invoke-virtual {v2, v0, v4}, Liz;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public a(Landroid/net/Uri;Laje;)V
    .locals 6
    ...
    invoke-static {v0}, Lahz;->a(Ljava/lang/String;)I
    ...
    invoke-direct {v3, v2, v1}, Lait;-><init>(ILandroid/accounts/Account;)V
    ...
    invoke-direct {v0, p0, v1}, Laiv;-><init>(Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;Landroid/os/Handler;)V

    invoke-virtual {v3, v0}, Lait;->a(Laiv;)V
...
.method public c(I)Landroid/net/Uri;
    ...
    .line 441
    sget-object v0, Ldcj;->bG:Ljava/util/Random;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-direct {v2, p0, v0}, Lerr;-><init>(Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;Landroid/net/Uri;)V
    ...
    .line 130
    :goto_1
    invoke-virtual {p0}, Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;->g()Lrk;

    move-result-object v0

    .line 131
    invoke-virtual {v0, v4}, Lrk;->b(Z)V
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    iget-object v0, p0, Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;->n:Ljfq;
    ...
    invoke-direct {v0, p0}, Lerq;-><init>(Lcom/google/android/apps/hangouts/phone/ViewVCardActivity;)V
    ...
    .line 7431
    invoke-virtual {v0, v1}, Lerq;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
