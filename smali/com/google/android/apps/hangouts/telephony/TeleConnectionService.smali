...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0}, Lgil;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/google/android/apps/hangouts/telephony/TeleConnectionService;->a:Lgil;
...
# virtual methods
.method public a()Lgil;
    .locals 1

    .prologue
    .line 136
    iget-object v0, p0, Lcom/google/android/apps/hangouts/telephony/TeleConnectionService;->a:Lgil;
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p2}, Lgil;->a(Ljava/io/PrintWriter;)V
...
.method public onConference(Landroid/telecom/Connection;Landroid/telecom/Connection;)V
    ...
    .line 47
    instance-of v0, p1, Lgem;

    if-eqz v0, :cond_0

    instance-of v0, p2, Lgem;
    ...
    invoke-interface {v0, v1}, Lgdy;->a(Lgdy;)V
...
.method public onCreateIncomingConnection(Landroid/telecom/PhoneAccountHandle;Landroid/telecom/ConnectionRequest;)Landroid/telecom/Connection;
    ...
    invoke-direct {v0, p0, v3}, Lger;-><init>(Landroid/content/Context;I)V
    ...
    invoke-static {v4}, Lgfk;->a(Landroid/os/Bundle;)Lgfk;
    ...
    invoke-virtual {v0, p0, p2, v3, v1}, Lgfg;->a(Lcom/google/android/apps/hangouts/telephony/TeleConnectionService;Landroid/telecom/ConnectionRequest;Lger;Landroid/os/PowerManager$WakeLock;)Lgem;
    :try_end_0
    ...
    invoke-direct {v0, p0, p0, p2, v3}, Lgff;-><init>(Landroid/content/Context;Lcom/google/android/apps/hangouts/telephony/TeleConnectionService;Landroid/telecom/ConnectionRequest;Lger;)V

    .line 98
    invoke-virtual {v0}, Lgff;->a()Lgem;
    :try_end_1
...
.method public onCreateOutgoingConnection(Landroid/telecom/PhoneAccountHandle;Landroid/telecom/ConnectionRequest;)Landroid/telecom/Connection;
    ...
    .line 1065
    invoke-static {p0}, Lggt;->a(Landroid/content/Context;)I

    move-result v3

    invoke-direct {v2, p0, v3}, Lgga;-><init>(Landroid/content/Context;I)V

    invoke-direct {v1, p0, p2, v2, v4}, Lggd;-><init>(Lcom/google/android/apps/hangouts/telephony/TeleConnectionService;Landroid/telecom/ConnectionRequest;Lgga;Z)V

    .line 1067
    new-instance v2, Lgem;

    invoke-direct {v2, v1}, Lgem;-><init>(Lggd;)V

    .line 1070
    new-instance v1, Lggc;

    invoke-direct {v1, v0, v2}, Lggc;-><init>(Landroid/content/Context;Lgem;)V

    invoke-virtual {v1}, Lggc;->a()V
...
.method public onRemoteConferenceAdded(Landroid/telecom/RemoteConference;)V
    ...
    invoke-direct {v0, v1, p1, p0}, Lggp;-><init>(Landroid/telecom/PhoneAccountHandle;Landroid/telecom/RemoteConference;Lcom/google/android/apps/hangouts/telephony/TeleConnectionService;)V
...
.method public onRemoteExistingConnectionAdded(Landroid/telecom/RemoteConnection;)V
    ...
    invoke-direct {v1, p1}, Lggr;-><init>(Landroid/telecom/RemoteConnection;)V
