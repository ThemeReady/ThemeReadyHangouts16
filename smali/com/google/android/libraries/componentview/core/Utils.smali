...
.method public static a(Ljava/util/List;Ljava/util/concurrent/Executor;Lnaf;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p2, v0}, Lnaf;->b(Ljava/lang/Object;)Z
    ...
    .line 171
    invoke-interface {v0}, Lmzu;->isDone()Z
    ...
    invoke-direct {v3, v0, p2, p0}, Lcom/google/android/libraries/componentview/core/Utils$1;-><init>(Ljava/util/concurrent/atomic/AtomicInteger;Lnaf;Ljava/util/List;)V
    ...
    .line 198
    invoke-interface {v1, v3, p1}, Lmzu;->a(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V

    goto :goto_2
.end method

.method public static a(Lmzu;Lnaf;Ljava/util/concurrent/Executor;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p1, p0}, Lcom/google/android/libraries/componentview/core/Utils$2;-><init>(Lnaf;Lmzu;)V
