...
# virtual methods
.method public a(Landroid/util/AttributeSet;)Lxt;
    .locals 2
    ...
    invoke-direct {v0, v1, p1}, Lxt;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    return-object v0
.end method

.method public a(Landroid/view/ViewGroup$LayoutParams;)Lxt;
    .locals 2
    ...
    invoke-direct {v0, p1}, Lxt;-><init>(Lxt;)V
    ...
    invoke-direct {v0, p1}, Lxt;-><init>(Landroid/view/ViewGroup$LayoutParams;)V

    goto :goto_0

    .line 605
    :cond_2
    invoke-virtual {p0}, Landroid/support/v7/widget/ActionMenuView;->b()Lxt;
...
.method public a(Lwb;)V
    ...
    .prologue
    .line 636
    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuView;->c:Lwb;
...
.method public a(Lwr;Lwc;)V
    ...
    .prologue
    .line 669
    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuView;->h:Lwr;

    .line 670
    iput-object p2, p0, Landroid/support/v7/widget/ActionMenuView;->a:Lwc;
...
.method public a(Lxk;)V
    ...
    .prologue
    .line 122
    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuView;->g:Lxk;

    .line 123
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuView;->g:Lxk;

    invoke-virtual {v0, p0}, Lxk;->a(Landroid/support/v7/widget/ActionMenuView;)V
...
.method public a(Lxv;)V
    ...
    .prologue
    .line 141
    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuView;->b:Lxv;
...
.method public a(Lwf;)Z
    ...
    .prologue
    .line 624
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuView;->c:Lwb;

    const/4 v1, 0x0

    invoke-virtual {v0, p1, v1}, Lwb;->a(Landroid/view/MenuItem;I)Z
...
.method public synthetic b(Landroid/util/AttributeSet;)Laaz;
    .locals 1

    .prologue
    .line 48
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/ActionMenuView;->a(Landroid/util/AttributeSet;)Lxt;
...
.method protected synthetic b(Landroid/view/ViewGroup$LayoutParams;)Laaz;
    .locals 1

    .prologue
    .line 48
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/ActionMenuView;->a(Landroid/view/ViewGroup$LayoutParams;)Lxt;
...
.method protected b()Lxt;
    ...
    invoke-direct {v0, v1, v1}, Lxt;-><init>(II)V
...
.method public b(Z)V
    ...
    invoke-virtual {v0, v1}, Lxk;->d(Z)V
...
.method public d()Landroid/view/Menu;
    ...
    invoke-direct {v1, v0}, Lwb;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->c:Lwb;

    .line 651
    iget-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->c:Lwb;

    new-instance v2, Lxu;

    invoke-direct {v2, p0}, Lxu;-><init>(Landroid/support/v7/widget/ActionMenuView;)V

    invoke-virtual {v1, v2}, Lwb;->a(Lwc;)V
    ...
    iput-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->g:Lxk;
    ...
    invoke-virtual {v0, v1}, Lxk;->c(Z)V

    .line 654
    iget-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->g:Lxk;

    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuView;->h:Lwr;
    ...
    :goto_0
    invoke-virtual {v1, v0}, Lxk;->a(Lwr;)V
    ...
    invoke-direct {v0, p0}, Lxs;-><init>(Landroid/support/v7/widget/ActionMenuView;)V
...
.method protected synthetic k()Laaz;
    .locals 1
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .prologue
    .line 128
    invoke-super {p0, p1}, Laay;->onConfigurationChanged(Landroid/content/res/Configuration;)V
...
.method protected onLayout(ZIIII)V
    ...
    .line 440
    invoke-super/range {p0 .. p5}, Laay;->onLayout(ZIIII)V
    ...
    iget-boolean v5, v0, Lxt;->a:Z

    if-nez v5, :cond_b

    .line 516
    iget v5, v0, Lxt;->rightMargin:I
...
.method protected onMeasure(II)V
    ...
    iget-object v7, v0, Landroid/support/v7/widget/ActionMenuView;->c:Lwb;
    ...
    iget-object v6, v0, Landroid/support/v7/widget/ActionMenuView;->c:Lwb;

    const/4 v7, 0x1

    invoke-virtual {v6, v7}, Lwb;->b(Z)V
    ...
    iput-boolean v7, v6, Lxt;->d:Z

    .line 1231
    const/4 v7, 0x0

    iput v7, v6, Lxt;->leftMargin:I

    .line 1232
    const/4 v7, 0x0

    iput v7, v6, Lxt;->rightMargin:I
    ...
    :goto_3
    iput-boolean v7, v6, Lxt;->e:Z

    .line 1236
    iget-boolean v7, v6, Lxt;->a:Z
    ...
    iput-boolean v8, v6, Lxt;->f:Z

    .line 1341
    if-nez v9, :cond_11

    iget-boolean v8, v6, Lxt;->e:Z
    ...
    iput v9, v6, Lxt;->rightMargin:I

    iput v9, v6, Lxt;->leftMargin:I
    ...
    .line 172
    :cond_1d
    invoke-super/range {p0 .. p2}, Laay;->onMeasure(II)V
