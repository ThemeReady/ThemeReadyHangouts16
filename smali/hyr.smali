...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lhyr;->b:Landroid/os/Handler;

    const/4 v0, 0x0

    new-array v0, v0, [Ljava/lang/String;

    sput-object v0, Lhyr;->c:[Ljava/lang/String;
    ...
    sput-object v0, Lhyr;->d:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Lhyr;->e:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Lhyr;->f:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Lhyr;->g:Ljava/util/regex/Pattern;

    const-string v0, "\u0001"

    sput-object v0, Lhyr;->h:Ljava/lang/String;

    const-string v0, "\u0002"

    sput-object v0, Lhyr;->i:Ljava/lang/String;

    new-instance v0, Ljava/security/SecureRandom;

    invoke-direct {v0}, Ljava/security/SecureRandom;-><init>()V

    sput-object v0, Lhyr;->j:Ljava/security/SecureRandom;

    new-instance v0, Lhys;

    invoke-direct {v0}, Lhys;-><init>()V

    sput-object v0, Lhyr;->k:Ljava/lang/ThreadLocal;

    new-instance v0, Lhyt;

    invoke-direct {v0}, Lhyt;-><init>()V

    sput-object v0, Lhyr;->l:Ljava/lang/ThreadLocal;

    new-instance v0, Lhyu;

    invoke-direct {v0}, Lhyu;-><init>()V

    sput-object v0, Lhyr;->m:Ljava/lang/ThreadLocal;

    new-instance v0, Lhyv;

    invoke-direct {v0}, Lhyv;-><init>()V

    sput-object v0, Lhyr;->n:Ljava/lang/ThreadLocal;

    new-instance v0, Lhyw;

    invoke-direct {v0}, Lhyw;-><init>()V

    sput-object v0, Lhyr;->o:Ljava/lang/ThreadLocal;

    new-instance v0, Lhyx;

    invoke-direct {v0}, Lhyx;-><init>()V

    sput-object v0, Lhyr;->p:Ljava/lang/ThreadLocal;
...
.method public static a()Ljava/lang/StringBuilder;
    ...
    sget-object v0, Lhyr;->k:Ljava/lang/ThreadLocal;
...
.method public static b(Ljava/lang/String;)[Ljava/lang/String;
    ...
    sget-object v0, Lhyr;->c:[Ljava/lang/String;

    :goto_0
    return-object v0

    :cond_0
    sget-object v0, Lhyr;->d:Ljava/util/regex/Pattern;
