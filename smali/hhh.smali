...
.field final synthetic c:Lhhg;


# direct methods
.method constructor <init>(Lhhg;Lhhp;Lhgz;Lcom/google/android/gms/signin/internal/SignInResponse;)V
    .locals 0

    iput-object p1, p0, Lhhh;->c:Lhhg;

    iput-object p3, p0, Lhhh;->a:Lhgz;

    iput-object p4, p0, Lhhh;->b:Lcom/google/android/gms/signin/internal/SignInResponse;
...
.method public a()V
    ...
    .prologue
    .line 0
    iget-object v0, p0, Lhhh;->a:Lhgz;

    iget-object v1, p0, Lhhh;->b:Lcom/google/android/gms/signin/internal/SignInResponse;

    .line 2000
    const/4 v2, 0x0

    invoke-virtual {v0, v2}, Lhgz;->b(I)Z
    ...
    invoke-virtual {v0, v2}, Lhgz;->b(Lcom/google/android/gms/common/ConnectionResult;)V
    ...
    iput-boolean v2, v0, Lhgz;->g:Z

    invoke-virtual {v1}, Lcom/google/android/gms/common/internal/ResolveAccountResponse;->a()Lgyr;

    move-result-object v2

    iput-object v2, v0, Lhgz;->h:Lgyr;

    invoke-virtual {v1}, Lcom/google/android/gms/common/internal/ResolveAccountResponse;->c()Z

    move-result v2

    iput-boolean v2, v0, Lhgz;->i:Z

    invoke-virtual {v1}, Lcom/google/android/gms/common/internal/ResolveAccountResponse;->d()Z

    move-result v1

    iput-boolean v1, v0, Lhgz;->j:Z
    ...
    :cond_2
    invoke-virtual {v0, v2}, Lhgz;->a(Lcom/google/android/gms/common/ConnectionResult;)Z
