...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lgur;->c:Ljava/lang/String;

    sget v0, Landroid/os/Build$VERSION;->SDK_INT:I

    const-string v0, "androidPackageName"

    sput-object v0, Lgur;->d:Ljava/lang/String;
    ...
    sput-object v0, Lgur;->e:Landroid/content/ComponentName;
    ...
    sput-object v0, Lgur;->a:Landroid/content/ComponentName;

    return-void
.end method

.method static a(Landroid/content/Context;Landroid/content/ComponentName;Lguu;)Ljava/lang/Object;
    .locals 5
    ...
    invoke-static {p0}, Lgyl;->a(Landroid/content/Context;)Lgyl;

    move-result-object v2

    const-string v0, "GoogleAuthUtil"

    invoke-virtual {v2, p1, v1, v0}, Lgyl;->a(Landroid/content/ComponentName;Landroid/content/ServiceConnection;Ljava/lang/String;)Z
    ...
    :try_start_0
    invoke-virtual {v1}, Lgzw;->a()Landroid/os/IBinder;

    move-result-object v0

    invoke-interface {p2, v0}, Lguu;->a(Landroid/os/IBinder;)Ljava/lang/Object;
    :try_end_0
    ...
    invoke-virtual {v2, p1, v1, v3}, Lgyl;->b(Landroid/content/ComponentName;Landroid/content/ServiceConnection;Ljava/lang/String;)V
...
.method static a(Landroid/content/Context;)V
    ...
    invoke-static {v0}, Lgvv;->e(Landroid/content/Context;)V
    :try_end_0
    ...
    invoke-direct {v1, v2, v3, v0}, Lguv;-><init>(ILjava/lang/String;Landroid/content/Intent;)V
    ...
    invoke-virtual {v0}, Lgvr;->getMessage()Ljava/lang/String;

    move-result-object v0

    invoke-direct {v1, v0}, Lgup;-><init>(Ljava/lang/String;)V
...
.method public static b(Landroid/content/Context;Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/String;
    ...
    invoke-static {p0, p1, p2, p3}, Lgur;->c(Landroid/content/Context;Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)Lcom/google/android/gms/auth/TokenData;
...
.method public static c(Landroid/content/Context;Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)Lcom/google/android/gms/auth/TokenData;
    ...
    invoke-static {v0}, Lacs;->E(Ljava/lang/String;)V

    const-string v0, "Scope cannot be empty or null."

    invoke-static {p2, v0}, Lacs;->a(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;

    const-string v0, "Account cannot be null."

    invoke-static {p1, v0}, Lacs;->e(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    invoke-static {p0}, Lgur;->a(Landroid/content/Context;)V
    ...
    sget-object v2, Lgur;->d:Ljava/lang/String;
    ...
    invoke-direct {v1, p1, p2, v0}, Lgus;-><init>(Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)V

    sget-object v0, Lgur;->e:Landroid/content/ComponentName;

    invoke-static {p0, v0, v1}, Lgur;->a(Landroid/content/Context;Landroid/content/ComponentName;Lguu;)Ljava/lang/Object;
