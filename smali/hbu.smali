...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lhbu;->b:Landroid/content/Context;

    return-void
.end method

.method static declared-synchronized a(Landroid/content/Context;)Lhbu;
    .locals 2
    ...
    invoke-direct {v0, p0}, Lhbu;-><init>(Landroid/content/Context;)V
...
.method private b(Landroid/os/Bundle;)Landroid/app/PendingIntent;
    ...
    invoke-static {p1, v0}, Lhbu;->a(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v1, p0, Lhbu;->b:Landroid/content/Context;
    ...
    invoke-static {v0}, Lhbd;->b(Landroid/os/Bundle;)V
    ...
    :cond_2
    iget-object v0, p0, Lhbu;->b:Landroid/content/Context;
...
.method private b(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, p2}, Lhbu;->a(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v4, p0, Lhbu;->b:Landroid/content/Context;
    ...
    :goto_2
    invoke-static {v0}, Lhbu;->a(Ljava/lang/String;)Ljava/lang/String;
...
.method a(Landroid/os/Bundle;)Z
    ...
    invoke-direct {p0, p1, v0}, Lhbu;->b(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v7, p0, Lhbu;->b:Landroid/content/Context;
    ...
    .line 1000
    :goto_1
    invoke-direct {p0, p1}, Lhbu;->b(Landroid/os/Bundle;)Landroid/app/PendingIntent;

    move-result-object v7

    new-instance v8, Ldt;

    iget-object v9, p0, Lhbu;->b:Landroid/content/Context;

    invoke-direct {v8, v9}, Ldt;-><init>(Landroid/content/Context;)V

    const/4 v9, 0x1

    invoke-virtual {v8, v9}, Ldt;->e(Z)Ldt;

    move-result-object v8

    invoke-virtual {v8, v3}, Ldt;->a(I)Ldt;
    ...
    invoke-virtual {v3, v4}, Ldt;->a(Ljava/lang/CharSequence;)Ldt;
    ...
    invoke-virtual {v3, v5}, Ldt;->b(Ljava/lang/CharSequence;)Ldt;
    ...
    invoke-virtual {v3, v4}, Ldt;->e(I)Ldt;

    :cond_1
    if-eqz v0, :cond_2

    invoke-virtual {v3, v0}, Ldt;->a(Landroid/net/Uri;)Ldt;

    :cond_2
    if-eqz v7, :cond_3

    invoke-virtual {v3, v7}, Ldt;->a(Landroid/app/PendingIntent;)Ldt;

    :cond_3
    invoke-virtual {v3}, Ldt;->b()Landroid/app/Notification;
    ...
    iget-object v8, p0, Lhbu;->b:Landroid/content/Context;
    ...
    invoke-virtual {v0}, Lhbv;->getMessage()Ljava/lang/String;
