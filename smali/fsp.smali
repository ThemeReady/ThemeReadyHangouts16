...
.method public constructor <init>(Landroid/content/Context;Lmah;)V
    .locals 4

    .prologue
    .line 32
    iget-object v0, p2, Lmah;->a:Lltm;

    iget-object v0, v0, Lltm;->a:Ljava/lang/String;

    iget-object v1, p2, Lmah;->b:Llym;
    ...
    iget-object v2, p2, Lmah;->c:Ljava/lang/Long;
    ...
    .line 36
    iget-object v0, p2, Lmah;->d:Ljava/lang/Integer;
    ...
    .line 37
    iget-object v0, p2, Lmah;->e:Ljava/lang/Integer;
...
.method protected a(Lbkv;Lfjv;)V
    ...
    invoke-virtual {v0, v4}, Lefu;->equals(Ljava/lang/Object;)Z
    ...
    .line 5162
    :goto_1
    sget-object v5, Lcom/google/android/apps/hangouts/realtimechat/RealTimeChatService;->h:Landroid/os/Handler;

    new-instance v6, Lfkm;

    invoke-direct {v6, v3, v4, v0}, Lfkm;-><init>(Ljava/lang/String;Lefu;Z)V
    ...
    :goto_2
    invoke-direct {v4, v5, v1}, Lfsu;-><init>(Lefu;Z)V

    .line 98
    invoke-static {v3}, Lfsu;->a(Ljava/lang/String;)Lgkc;

    move-result-object v1

    .line 96
    invoke-interface {v0, v4, v1}, Lgke;->a(Laww;Lgkc;)V
    :try_end_1
