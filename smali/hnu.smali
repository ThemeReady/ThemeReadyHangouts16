...
# direct methods
.method public static a(Landroid/os/IBinder;)Lhnt;
    .locals 2
    ...
    invoke-direct {v0, p0}, Lhnv;-><init>(Landroid/os/IBinder;)V
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-virtual {p0}, Lhnu;->a()Lcom/google/android/gms/maps/model/CameraPosition;
    ...
    invoke-static {v0}, Lhal;->a(Landroid/os/IBinder;)Lhak;

    move-result-object v0

    invoke-virtual {p0, v0}, Lhnu;->a(Lhak;)V
    ...
    invoke-virtual {p0, v0}, Lhnu;->b(Lhak;)V
    ...
    invoke-static {v1}, Lhpr;->a(Landroid/os/IBinder;)Lhpq;

    move-result-object v1

    invoke-virtual {p0, v0, v1}, Lhnu;->a(Lhak;Lhpq;)V
    ...
    invoke-static {v3}, Lhpr;->a(Landroid/os/IBinder;)Lhpq;

    move-result-object v3

    invoke-virtual {p0, v0, v1, v3}, Lhnu;->a(Lhak;ILhpq;)V
    ...
    sget-object v0, Lcom/google/android/gms/maps/model/PolylineOptions;->CREATOR:Lhub;
    ...
    :goto_1
    invoke-virtual {p0, v0}, Lhnu;->a(Lcom/google/android/gms/maps/model/PolylineOptions;)Lhss;
    ...
    sget-object v0, Lcom/google/android/gms/maps/model/PolygonOptions;->CREATOR:Lhua;
    ...
    :goto_2
    invoke-virtual {p0, v0}, Lhnu;->a(Lcom/google/android/gms/maps/model/PolygonOptions;)Lhtk;
    ...
    invoke-interface {v0}, Lhtk;->asBinder()Landroid/os/IBinder;
    ...
    sget-object v0, Lcom/google/android/gms/maps/model/MarkerOptions;->CREATOR:Lhty;
    ...
    :goto_3
    invoke-virtual {p0, v0}, Lhnu;->a(Lcom/google/android/gms/maps/model/MarkerOptions;)Lhth;
    ...
    sget-object v0, Lcom/google/android/gms/maps/model/GroundOverlayOptions;->CREATOR:Lhtv;

    invoke-virtual {v0, p2}, Lhtv;->createFromParcel(Landroid/os/Parcel;)Ljava/lang/Object;
    ...
    :goto_4
    invoke-virtual {p0, v0}, Lhnu;->a(Lcom/google/android/gms/maps/model/GroundOverlayOptions;)Lhtb;
    ...
    sget-object v0, Lcom/google/android/gms/maps/model/TileOverlayOptions;->CREATOR:Lhuh;

    invoke-virtual {v0, p2}, Lhuh;->createFromParcel(Landroid/os/Parcel;)Ljava/lang/Object;
    ...
    :goto_5
    invoke-virtual {p0, v0}, Lhnu;->a(Lcom/google/android/gms/maps/model/TileOverlayOptions;)Lhtn;
    ...
    invoke-interface {v0}, Lhtn;->asBinder()Landroid/os/IBinder;
    ...
    invoke-virtual {p0, v0}, Lhnu;->a(I)V
    ...
    :cond_c
    invoke-virtual {p0, v3}, Lhnu;->a(Z)V
    ...
    :goto_7
    invoke-virtual {p0, v0}, Lhnu;->b(Z)Z
    ...
    :cond_11
    invoke-virtual {p0, v3}, Lhnu;->c(Z)V
    ...
    invoke-virtual {p0}, Lhnu;->j()Landroid/location/Location;
    ...
    .line 0
    :goto_8
    invoke-virtual {p0, v1}, Lhnu;->a(Lhnw;)V
    ...
    invoke-direct {v1, v3}, Lhny;-><init>(Landroid/os/IBinder;)V
    ...
    .line 0
    :goto_9
    invoke-virtual {p0, v1}, Lhnu;->a(Lhpz;)V
    ...
    .line 0
    :goto_a
    invoke-virtual {p0, v1}, Lhnu;->a(Lhrj;)V
    ...
    invoke-direct {v1, v3}, Lhrl;-><init>(Landroid/os/IBinder;)V
    ...
    .line 0
    :goto_b
    invoke-virtual {p0, v1}, Lhnu;->a(Lhrp;)V
    ...
    .line 0
    :goto_c
    invoke-virtual {p0, v1}, Lhnu;->a(Lhrv;)V
    ...
    .line 0
    :goto_d
    invoke-virtual {p0, v1}, Lhnu;->a(Lhry;)V
    ...
    .line 0
    :goto_e
    invoke-virtual {p0, v1}, Lhnu;->a(Lhqx;)V
    ...
    invoke-direct {v1, v3}, Lhqz;-><init>(Landroid/os/IBinder;)V
    ...
    .line 0
    :goto_f
    invoke-virtual {p0, v1}, Lhnu;->a(Lhpw;)V
    ...
    sget-object v0, Lcom/google/android/gms/maps/model/CircleOptions;->CREATOR:Lhtu;

    invoke-virtual {v0, p2}, Lhtu;->createFromParcel(Landroid/os/Parcel;)Ljava/lang/Object;
    ...
    :goto_10
    invoke-virtual {p0, v0}, Lhnu;->a(Lcom/google/android/gms/maps/model/CircleOptions;)Lhsy;
    ...
    .line 0
    :goto_11
    invoke-virtual {p0, v1}, Lhnu;->a(Lhse;)V
    ...
    invoke-direct {v1, v3}, Lhsg;-><init>(Landroid/os/IBinder;)V
    ...
    .line 0
    :goto_12
    invoke-virtual {p0, v1}, Lhnu;->a(Lhsb;)V
    ...
    invoke-static {v0}, Lhpn;->a(Landroid/os/IBinder;)Lhpm;
    ...
    invoke-static {v1}, Lhal;->a(Landroid/os/IBinder;)Lhak;

    move-result-object v1

    invoke-virtual {p0, v0, v1}, Lhnu;->a(Lhpm;Lhak;)V
    ...
    invoke-virtual {p0, v0, v1, v3, v4}, Lhnu;->a(IIII)V
    ...
    :cond_2c
    invoke-virtual {p0, v3}, Lhnu;->d(Z)V
    ...
    .line 0
    :goto_13
    invoke-virtual {p0, v1}, Lhnu;->a(Lhrm;)V
    ...
    .line 0
    :goto_14
    invoke-virtual {p0, v1}, Lhnu;->a(Lhqu;)V
    ...
    :cond_32
    invoke-virtual {p0, v3}, Lhnu;->e(Z)V
    ...
    invoke-static {v0}, Lhrt;->a(Landroid/os/IBinder;)Lhrs;

    move-result-object v0

    invoke-virtual {p0, v0}, Lhnu;->a(Lhrs;)V
    ...
    :goto_16
    invoke-virtual {p0, v0}, Lhnu;->b(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v0}, Lhnu;->a(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, Lhnu;->a(Lhpm;)V
    ...
    .line 0
    :goto_17
    invoke-virtual {p0, v1}, Lhnu;->a(Lhsh;)V
    ...
    invoke-direct {v1, v3}, Lhsj;-><init>(Landroid/os/IBinder;)V
    ...
    :goto_18
    invoke-virtual {p0, v0}, Lhnu;->c(Landroid/os/Bundle;)V
    ...
    .line 0
    :goto_19
    invoke-virtual {p0, v1}, Lhnu;->a(Lhqr;)V
    ...
    .line 0
    :goto_1a
    invoke-virtual {p0, v1}, Lhnu;->a(Lhrd;)V
    ...
    .line 0
    :goto_1b
    invoke-virtual {p0, v1}, Lhnu;->a(Lhsk;)V
    ...
    invoke-direct {v1, v3}, Lhsm;-><init>(Landroid/os/IBinder;)V
    ...
    .line 0
    :goto_1c
    invoke-virtual {p0, v1}, Lhnu;->a(Lhra;)V
    ...
    .line 0
    :goto_1d
    invoke-virtual {p0, v1}, Lhnu;->a(Lhou;)V
    ...
    invoke-direct {v1, v3}, Lhow;-><init>(Landroid/os/IBinder;)V
    ...
    .line 0
    :goto_1e
    invoke-virtual {p0, v1}, Lhnu;->a(Lhqo;)V
    ...
    invoke-virtual {p0, v0}, Lhnu;->a([B)V
    ...
    invoke-virtual {p0, v0}, Lhnu;->a(F)V
    ...
    invoke-virtual {p0, v0}, Lhnu;->b(F)V
    ...
    sget-object v0, Lcom/google/android/gms/maps/model/LatLngBounds;->CREATOR:Lhtw;

    invoke-virtual {v0, p2}, Lhtw;->createFromParcel(Landroid/os/Parcel;)Ljava/lang/Object;
    ...
    :goto_1f
    invoke-virtual {p0, v0}, Lhnu;->a(Lcom/google/android/gms/maps/model/LatLngBounds;)V
    ...
    .line 0
    :goto_20
    invoke-virtual {p0, v1}, Lhnu;->a(Lhql;)V
    ...
    .line 0
    :goto_21
    invoke-virtual {p0, v1}, Lhnu;->a(Lhqi;)V
    ...
    .line 0
    :goto_22
    invoke-virtual {p0, v1}, Lhnu;->a(Lhqf;)V
    ...
    .line 0
    :goto_23
    invoke-virtual {p0, v1}, Lhnu;->a(Lhqc;)V
