...
.method public static a(Landroid/content/Context;)I
    ...
    invoke-static {p0}, Lgvv;->d(Landroid/content/Context;)I
...
.method public static a(ILandroid/app/Activity;I)Landroid/app/Dialog;
    ...
    .prologue
    .line 2000
    invoke-static {p1, p0}, Lgvv;->b(Landroid/content/Context;I)Z
    ...
    invoke-virtual {v0, p1, p0, p2, v1}, Lgvp;->a(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
...
.method public static a(I)Landroid/content/Intent;
    ...
    .line 17000
    invoke-virtual {v0, v1, p0, v1}, Lgvq;->a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
...
.method public static a(ILandroid/content/Context;)V
    ...
    invoke-static {p1, v0}, Lgvv;->a(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, p1, p0, v1, v2}, Lgvq;->a(Landroid/content/Context;IILjava/lang/String;)Landroid/app/PendingIntent;

    move-result-object v0

    const/4 v1, 0x0

    invoke-static {p0, p1, v1, v0}, Lgvt;->a(ILandroid/content/Context;Ljava/lang/String;Landroid/app/PendingIntent;)V
...
.method static a(ILandroid/content/Context;Landroid/app/PendingIntent;)V
    ...
    invoke-static {p0, p1, v0, p2}, Lgvt;->a(ILandroid/content/Context;Ljava/lang/String;Landroid/app/PendingIntent;)V
...
.method private static a(ILandroid/content/Context;Ljava/lang/String;Landroid/app/PendingIntent;)V
    ...
    invoke-static {p1, p0}, Lgyd;->b(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_0
    invoke-static {p1, p0, v4}, Lgyd;->b(Landroid/content/Context;ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {}, Lacs;->M()Z

    move-result v5

    invoke-static {v5}, Lacs;->a(Z)V
    ...
    sget-object v1, Lgvt;->f:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-direct {v5, p1}, Ldt;-><init>(Landroid/content/Context;)V

    invoke-virtual {v5, v6}, Ldt;->a(I)Ldt;

    move-result-object v5

    invoke-virtual {v5, v3}, Ldt;->d(Ljava/lang/CharSequence;)Ldt;
    ...
    invoke-virtual {v3, v6, v7}, Ldt;->a(J)Ldt;

    move-result-object v3

    invoke-virtual {v3, v1}, Ldt;->e(Z)Ldt;

    move-result-object v3

    invoke-virtual {v3, p3}, Ldt;->a(Landroid/app/PendingIntent;)Ldt;

    move-result-object v3

    invoke-virtual {v3, v0}, Ldt;->a(Ljava/lang/CharSequence;)Ldt;
...
.method public static a(ILandroid/app/Activity;ILandroid/content/DialogInterface$OnCancelListener;)Z
    ...
    .line 4000
    invoke-virtual {v0, p1, p0, p2, p3}, Lgvp;->b(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Z
...
.method public static b(Landroid/content/Context;)Landroid/content/res/Resources;
    ...
    invoke-static {p0}, Lgvv;->h(Landroid/content/Context;)Landroid/content/res/Resources;
...
.method static synthetic b(ILandroid/content/Context;)V
    ...
    invoke-static {p0, p1}, Lgvt;->c(ILandroid/content/Context;)V
...
.method public static b(ILandroid/app/Activity;I)Z
    ...
    invoke-static {p0, p1, v0, v1}, Lgvt;->a(ILandroid/app/Activity;ILandroid/content/DialogInterface$OnCancelListener;)Z
