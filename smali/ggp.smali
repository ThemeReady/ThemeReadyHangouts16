...
.method public constructor <init>(Landroid/telecom/PhoneAccountHandle;Landroid/telecom/RemoteConference;Lcom/google/android/apps/hangouts/telephony/TeleConnectionService;)V
    ...
    invoke-direct {v0, p0}, Lggq;-><init>(Lggp;)V

    iput-object v0, p0, Lggp;->c:Landroid/telecom/RemoteConference$Callback;

    .line 39
    iput-object p2, p0, Lggp;->a:Landroid/telecom/RemoteConference;

    .line 40
    iput-object p3, p0, Lggp;->b:Lcom/google/android/apps/hangouts/telephony/TeleConnectionService;
    ...
    invoke-virtual {p0, v0}, Lggp;->setConnectionCapabilities(I)V
    ...
    invoke-virtual {p0, v0}, Lggp;->a(I)V

    .line 43
    iget-object v0, p0, Lggp;->c:Landroid/telecom/RemoteConference$Callback;
    ...
    .line 46
    invoke-static {v0, p3}, Lggj;->a(Landroid/telecom/RemoteConnection;Lcom/google/android/apps/hangouts/telephony/TeleConnectionService;)Landroid/telecom/Connection;
    ...
    .line 48
    invoke-virtual {p0, v2}, Lggp;->addConnection(Landroid/telecom/Connection;)Z
...
.method a(I)V
    ...
    .line 132
    :pswitch_1
    invoke-virtual {p0}, Lggp;->setOnHold()V

    goto :goto_0

    .line 135
    :pswitch_2
    invoke-virtual {p0}, Lggp;->setActive()V
...
.method public onAudioStateChanged(Landroid/telecom/AudioState;)V
    ...
    .line 123
    iget-object v0, p0, Lggp;->a:Landroid/telecom/RemoteConference;
...
.method public onSeparate(Landroid/telecom/Connection;)V
    ...
    .line 76
    instance-of v1, v0, Lggj;

    if-eqz v1, :cond_0

    .line 77
    iget-object v1, p0, Lggp;->a:Landroid/telecom/RemoteConference;

    check-cast v0, Lggj;

    invoke-virtual {v0}, Lggj;->n()Landroid/telecom/RemoteConnection;
