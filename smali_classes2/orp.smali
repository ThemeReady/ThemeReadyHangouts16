...
.method public static a(Ljava/io/InputStream;Ljava/lang/Integer;Ljava/lang/Integer;ZZZF)Lorn;
    .locals 9
    ...
    .line 2140
    invoke-direct {v4, v3}, Lorw;-><init>(Landroid/graphics/Picture;)V

    .line 330
    invoke-virtual {v4, p1, p2}, Lorw;->a(Ljava/lang/Integer;Ljava/lang/Integer;)V

    .line 331
    const/4 v5, 0x0

    invoke-virtual {v4, v5}, Lorw;->a(Z)V

    .line 332
    const/4 v5, 0x0

    invoke-virtual {v4, v5}, Lorw;->b(Z)V

    .line 333
    invoke-virtual {v4, p6}, Lorw;->a(F)V

    .line 338
    new-instance v5, Lorq;

    invoke-direct {v5, p0}, Lorq;-><init>(Ljava/io/InputStream;)V

    .line 340
    new-instance v6, Lors;

    .line 3073
    invoke-direct {v6}, Lors;-><init>()V
    ...
    invoke-virtual {v5}, Lorq;->a()Ljava/io/ByteArrayInputStream;
    ...
    .line 344
    iget-object v6, v6, Lors;->a:Ljava/util/HashMap;

    iput-object v6, v4, Lorw;->a:Ljava/util/HashMap;
    ...
    iget-object v1, v4, Lorw;->o:Landroid/graphics/RectF;

    invoke-direct {v0, v3, v1}, Lorn;-><init>(Landroid/graphics/Picture;Landroid/graphics/RectF;)V

    .line 352
    iget-object v1, v4, Lorw;->p:Landroid/graphics/RectF;
    ...
    invoke-virtual {v0, v1}, Lorn;->a(Landroid/graphics/RectF;)V
    :try_end_0
...
.method static a(Ljava/lang/String;)Loru;
    .locals 10
    ...
    invoke-direct {v0, v6, v4}, Loru;-><init>(Ljava/util/ArrayList;I)V
    ...
    invoke-direct {v0, v6, v3}, Loru;-><init>(Ljava/util/ArrayList;I)V
...
.method static a(Ljava/lang/String;Lorg/xml/sax/Attributes;)Loru;
    .locals 3
...
.method static b(Ljava/lang/String;)Landroid/graphics/Path;
    ...
    invoke-direct {v0, v1, v4}, Lorm;-><init>(Ljava/lang/CharSequence;I)V

    .line 572
    invoke-virtual/range {v28 .. v28}, Lorm;->a()V
    ...
    .line 586
    invoke-virtual/range {v28 .. v28}, Lorm;->b()V
    ...
    .line 601
    :sswitch_0
    invoke-virtual/range {v28 .. v28}, Lorm;->c()F
