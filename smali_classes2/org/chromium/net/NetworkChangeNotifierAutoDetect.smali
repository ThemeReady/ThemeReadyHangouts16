...
# direct methods
.method public constructor <init>(Lper;Landroid/content/Context;Lpes;)V
    .locals 4
    ...
    .line 626
    iput-object p1, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->a:Lper;
    ...
    invoke-direct {v0, p2}, Lpej;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->b:Lpej;

    .line 629
    new-instance v0, Lpet;

    invoke-direct {v0, p2}, Lpet;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->f:Lpet;
    ...
    .line 1350
    invoke-direct {v0, p0}, Lpek;-><init>(Lorg/chromium/net/NetworkChangeNotifierAutoDetect;)V

    .line 631
    iput-object v0, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->g:Lpek;
    ...
    .line 641
    :goto_0
    invoke-virtual {p0}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->d()Lpeq;

    move-result-object v0

    .line 642
    invoke-static {v0}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->a(Lpeq;)I
    ...
    .line 643
    invoke-virtual {v0}, Lpeq;->d()Ljava/lang/String;
    ...
    .line 644
    invoke-virtual {p0, v0}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->c(Lpeq;)D
    ...
    .line 649
    iput-object p3, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->e:Lpes;

    .line 650
    iget-object v0, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->e:Lpes;

    invoke-virtual {v0, p0}, Lpes;->a(Lorg/chromium/net/NetworkChangeNotifierAutoDetect;)V
    ...
    .line 638
    :cond_0
    iput-object v3, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->g:Lpek;
...
.method public static a(Lpeq;)I
    ...
    :cond_0
    invoke-virtual {p0}, Lpeq;->b()I

    move-result v0

    invoke-virtual {p0}, Lpeq;->c()I
...
.method public static a(Lpej;Landroid/net/Network;)[Landroid/net/Network;
    .locals 8
    ...
    .line 750
    invoke-virtual {p0}, Lpej;->a()[Landroid/net/Network;
    ...
    .line 757
    invoke-virtual {p0, v6}, Lpej;->c(Landroid/net/Network;)Landroid/net/NetworkCapabilities;
    ...
    .line 764
    invoke-static {v6}, Lpej;->b(Landroid/net/Network;)Z
...
.method private d(Lpeq;)V
    .locals 3

    .prologue
    .line 950
    invoke-static {p1}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->a(Lpeq;)I

    move-result v0

    .line 951
    invoke-virtual {p1}, Lpeq;->d()Ljava/lang/String;
    ...
    .line 957
    iget-object v1, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->a:Lper;

    invoke-virtual {v1, v0}, Lper;->a(I)V

    goto :goto_0
.end method

.method private e(Lpeq;)V
    .locals 4

    .prologue
    .line 961
    invoke-virtual {p0, p1}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->c(Lpeq;)D
    ...
    .line 968
    iget-object v2, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->a:Lper;

    invoke-virtual {v2, v0, v1}, Lper;->a(D)V
...
.method public b()V
    ...
    .line 695
    invoke-direct {p0, v0}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->d(Lpeq;)V

    .line 696
    invoke-direct {p0, v0}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->e(Lpeq;)V

    .line 702
    :cond_2
    iget-object v0, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->d:Landroid/content/Context;

    iget-object v3, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->c:Lorg/chromium/net/NetworkChangeNotifierAutoDetect$NetworkConnectivityIntentFilter;
    ...
    .line 705
    iget-object v0, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->g:Lpek;
    ...
    invoke-virtual {v0}, Lpek;->a()V

    .line 707
    iget-object v0, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->b:Lpej;

    iget-object v1, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->h:Landroid/net/NetworkRequest;

    iget-object v3, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->g:Lpek;

    invoke-virtual {v0, v1, v3}, Lpej;->a(Landroid/net/NetworkRequest;Landroid/net/ConnectivityManager$NetworkCallback;)V
    ...
    invoke-static {v0, v1}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->a(Lpej;Landroid/net/Network;)[Landroid/net/Network;
    ...
    .line 721
    :cond_4
    iget-object v0, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->a:Lper;
...
.method public c(Lpeq;)D
    .locals 2

    .prologue
    .line 930
    invoke-static {p1}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->b(Lpeq;)I
...
.method public c()V
    ...
    iget-object v1, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->g:Lpek;

    invoke-virtual {v0, v1}, Lpej;->a(Landroid/net/ConnectivityManager$NetworkCallback;)V

    goto :goto_0
.end method

.method public d()Lpeq;
    .locals 2
    ...
    iget-object v1, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->f:Lpet;

    invoke-virtual {v0, v1}, Lpej;->a(Lpet;)Lpeq;
...
.method public e()[J
    ...
    invoke-static {v0, v2}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->a(Lpej;Landroid/net/Network;)[Landroid/net/Network;
    ...
    iget-object v7, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->b:Lpej;

    invoke-virtual {v7, v5}, Lpej;->a(Landroid/net/Network;)I
